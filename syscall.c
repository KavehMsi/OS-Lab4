...
extern int sys_ret_cv(void);
extern int sys_do_cv(void);
extern int sys_read_write_initialize(void);
...
[SYS_ret_cv]   sys_ret_cv,
[SYS_do_cv]   sys_do_cv,
[SYS_read_write_initialize]   sys_read_write_initialize,
